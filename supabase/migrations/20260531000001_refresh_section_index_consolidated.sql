-- Consolidated refresh_section_index() with all sections including corrupcion.
-- Fixes the issue where the 20260623 migration (performance optimization)
-- overwrote the 20260525 migration that added corrupcion, causing the
-- Procesos judiciales count to be missing from the cache.
