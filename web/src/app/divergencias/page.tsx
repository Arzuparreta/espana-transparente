...
export const metadata = {
  ...
  description:
    "Diputados que han votado en contra de la posición oficial de su grupo parlamentario en sesiones con voto nominal.",
}
...
export default async function DivergenciasPage() {
  ...
  return (
    <div className="space-y-6 sm:space-y-8">
      <PageHeader
        title="Divergencias de voto"
        description="Diputados que han votado en contra de la posición oficial de su grupo parlamentario en sesiones con voto nominal. Una divergencia no implica posición personal: refleja un desacuerdo público registrado con la disciplina de grupo."
      />
