  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    if (modalMode === "login") {
      ...
      if (error) {
        ...
        setError(
          "La cuenta se ha creado, pero Supabase no ha devuelto sesión. Revisa la configuración de Auth: la confirmación por correo debe estar desactivada."
        )
        setLoading(false)
      } else {
        reset()
...
function translateError(msg: string): string {
  ...
  if (msg.includes("Email not confirmed")) {
    return "La configuración remota exige confirmar el correo. Revisa Auth en Supabase."
  }
